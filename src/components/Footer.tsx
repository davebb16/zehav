  ...
  return (
    <header className='flex gap-2 py-2'>
      <Wrapper>
        ...
        <img src={headerlogov2} className='-ml-4 w-48' alt='זהב' />
        <svg
          className='h-56 fill-transparent stroke-white stroke-2'
          version='1.1'
          id='Layer_1'
        ...
        >
          ...
          <path
            className='st0'
            d='M258.97,237.24c0,0,151.72-7.53,147.95,0c-3.76,7.53-66.26,21.08-66.26,21.08s84.71,6.4,84.33,37.27
	...
	s-4.71,4.14-0.56,6.59s2.82,11.95-7.34,10.87c-10.16-1.08,71.34-10.12,141.36-9.18'
          />
          <line className='st0' x1='380.2' y1='204.49' x2='282.31' y2='359.6' />
          <path
            className='st0'
            d='M207.02,220.68c0,0-88.09,134.4-81.69,132.89c6.4-1.51,94.49-113.69-65.88-95.25c0,0,199.91-32.75,234.92,11.29
